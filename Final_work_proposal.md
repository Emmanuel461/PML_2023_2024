...
The satellite image will be from PlanetScope (PS) sensor with 3x3m spatial resolution. For more details visit ([PlanetScope Bands](https://developers.planet.com/docs/apis/data/sensors/)). The image will correspond to the month of soil sampling (March 2022). The date of the image is 2022-05-28. 

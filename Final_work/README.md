...
<image src="/Images_report/Figura1.png" alt="Location map" caption="Figura 1: Ubicación general del área de estudio (A).Localización y distribución de los muestreos de suelos (B).">
